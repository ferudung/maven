...
public class C01_Maven {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //***implicitlyWait çok onemli
        //classın basında implicitlyWait komutu yazılırsa bu test boyunca
        //her locatör için mazimum yazılan zaman kadar bekler
        //illa süre bitmesini beklemez bulurda devam eder
        //ama süre bitene kadar yüklemezse hata fırlatır
